...
Rectangle {
        ...
        Flickable {
            ...
            Column {
                ...
                Repeater {
                    model: testModel
                    delegate: Text {
                        text: "<b>%1.</b> %2 (%3) -> %4 = %5".arg(
                                  model.foo).arg(model.bar).arg(model.test).arg(
                                  model.type).arg(model.qtObject)
                    }
                }
            }
        }
    ...
    Timer {
        ...
        property var listOperations: [function () {
            ...
            console.log("model move idx 100 to position 1=",
                        (testModel.move(100, 1) || "DONE"))
        }, function () {
